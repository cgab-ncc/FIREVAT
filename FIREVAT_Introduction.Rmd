...
With 2 cores (each with 3.5GHz clock speed) this sample script takes about 10 minutes to run.
```{r, eval=FALSE}
library(FIREVAT)
...
## 03. Inputs
To perform variant refinement using FIREVAT, you need to supply a VCF file and a FIREVAT configuration file.

### 03-1. Loading example data
```{r}
